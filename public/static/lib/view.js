	...
	layui.define(["laytpl", "layer"], function(e) {
		...
		i.loading = function(e) {
			...
			return e.data = e.data || {}, e.headers = e.headers || {}, a.tokenName && (e.data[a.tokenName] = a.tokenName in e.data ? e.data[a.tokenName] : layui.data(r.tableName)[a.tokenName] || "", e.headers[a.tokenName] = a.tokenName in e.headers ? e.headers[a.tokenName] : layui.data(r.tableName)[a.tokenName] || ""),
			delete e.success,
			delete e.error, t.ajax(t.extend({
				type : "get",
				dataType : "json",
				success : function(t) {
					var a = o.statusCode;
			...
			return e = r.views + e + r.engine, t("#" + s).children(".layadmin-loading").remove(), i.loading(a.container), t.ajax({
				...
				success : function(e) {
					e = "<div>" + e + "</div>";
					var r = t(e).find("title"), o = r.text(), s = {
						title : o,
						body : e
					};
					r.remove(), a.params = n || {}, a.then && (a.then(s),
					delete a.then), a.parse(e), i.removeLoad(), a.done && (a.done(s),
					delete a.done)
				},
				error : function(e) {
					return i.removeLoad(), a.render.isError ? i.error("请求视图文件异常，状态：" + e.status) : (404 === e.status ? a.render("template/tips/404") : a.render("template/tips/error"),
			...
			for (var p = l.length; p > 0; p--)
				! function() {
					var e = l.eq(p - 1), t = e.attr("lay-done") || e.attr("lay-then"), a = n(e.attr("lay-url") || "").render(y), r = n(e.attr("lay-data") || "").render(y), s = n(e.attr("lay-headers") || "").render(y);
					try {
